  ...
  return (
    <motion.div className="flex flex-col">
      ...
      <div className="flex flex-row">
        <p className="max-w-[96px] text-sm text-subheading/[.68]">Go to courses and enroll</p>
        <hr className="w-[126px] opacity-0" />
        <p className="max-w-[96px] text-sm text-subheading/[.68]">Complete assignments & project</p>
        <hr className="w-[126px] opacity-0" />
        <p className="max-w-[96px] text-sm text-subheading/[.68]">Take assessment to earn points</p>
      </div>
    </motion.div>
  )
}