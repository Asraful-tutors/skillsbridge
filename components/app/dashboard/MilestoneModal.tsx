...
export default function MilestoneModal({
  ...
  return (
    <div className="z-50 bg-black/[.70] w-screen h-screen absolute top-0 left-0 flex items-center px-4">
      <motion.div
        className={`popup w-full relative text-black max-w-screen-2xl h-[90%] rounded-2xl sm:mx-10 xl:mx-auto grid grid-cols-1 xl:grid-cols-10 gap-12 p-0 bg-white_background overflow-y-scroll`}
      >
        ...
        <div className="col-span-5 2xl:col-span-6 my-[77px] mx-12 relative">
          ...
          <div className="flex flex-col lg:mb-[42px]">
