      ...
      >
        ...
        <AnimatePresence>
          ...
          <motion.div
            ...
            className="fixed z-[49] right-2 sm:right-5 top-[160px] sm:top-44 w-[467px] h-auto bg-white_background p-5 rounded-lg flex flex-col gap-5 overflow-hidden max-h-[400px] max-w-xs sm:max-w-lg overflow-y-scroll"
          >
