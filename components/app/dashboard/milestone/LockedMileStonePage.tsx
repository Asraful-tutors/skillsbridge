...
export default function LockedMileStonePage({
  userSkills,
  userPaths,
}: {
  ...
  return (
    <motion.div
      className={`w-full text-black max-w-screen-2xl h-full my-8 rounded-2xl mx-auto grid  grid-cols-1 lg:grid-cols-10 gap-12 xl:pr-0 bg-white_background`}
    >
