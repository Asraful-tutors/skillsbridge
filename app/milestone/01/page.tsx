  ...
  return (
    <motion.div className="w-full text-black max-w-screen-2xl h-full my-8 rounded-2xl mx-auto grid grid-cols-1 xl:grid-cols-2 gap-12 py-[77px] xl:pr-0 px-12 bg-white_background">
      <div className="">
        ...
        <h1 className="text-[40px] font-bold mb-[18px]">Basic Coding for game development</h1>
        <Image
        ...
        <div className="py-[15px] mb-8">
          <h2 className="text-xl font-semibold mb-[27px] text-subheading">Tasks to complete</h2>
          <TaskProgress />
        </div>
        <Button
          /* onClick={} */
